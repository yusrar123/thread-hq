...
// 			return wishlist.filter((item) => item.status === "SALE");
...
// 		.filter((item) => item.originalPrice && item.price)
// 		.reduce((acc, item) => {
...
// 						<div>
// 							<div className="text-3xl font-light text-gray-900">
// 								{wishlist.filter((item) => item.status === "SALE").length}
// 							</div>
...
// 											<h3 className="text-white font-medium text-lg tracking-wide drop-shadow-lg">
